...
int main()
{
    ...
    cout << "Si necesitas ayuda, escribe 'help' o 'ayuda'." << endl
         << endl;
    ...
    while (true)
    {
        ...
        else if (valRutaMasCorta(command))
        {
            ...
            if (parseRutaMasCorta(command, i, j, x, y))
            {
                ...
                cout << "Parámetros convertidos: i=" << i << ", j=" << j << ", x=" << x << ", y=" << y << termcolor::reset << endl;
            }
            else
            {
                cout << termcolor::red << "Error: Parámetros inválidos para ruta_mas_corta." << termcolor::reset << endl;
            }
        }
